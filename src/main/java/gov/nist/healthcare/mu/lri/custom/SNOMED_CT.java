...
public class SNOMED_CT extends CodedElementFormat {
     ...
     * 
     * @param code
     *        the SNOMED code to check
     * @return true if code is a valid SNOMED
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sct.isValid("100005"));
        System.out.println(sct.isValid("999999990989121104"));
        System.out.println(sct.isValid("9940000001126"));
        System.out.println(sct.isValid("1290000001117"));
        System.out.println(sct.isValid("1290989121103"));
        System.out.println(sct.isValid("10989121108"));
        System.out.println(sct.isValid("10000001105"));
        System.out.println(sct.isValid("9940000001029"));
        System.out.println(sct.isValid("1290023401015"));
        System.out.println(sct.isValid("1290023401004"));
        System.out.println(sct.isValid("100022"));
        System.out.println(sct.isValid("100014"));
    }
}
